...
public class CalculatorModel {
    ...
    public void fromPolandToNormal() throws ru.mirea.task22.task1.EmptyStackException, ru.mirea.task22.task1.DivisionByZeroException, EmptyStringException, DoubleParseException {
        Double result = 0d;
    ...
    private Double operationResult(Double firstNum, Double secondNum, String operand) throws ru.mirea.task22.task1.DivisionByZeroException {
